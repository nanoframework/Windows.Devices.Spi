...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    $nativeFile = "win_dev_spi_native.cpp"
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/Windows.Devices.Spi/$env:MyNuGetVersion"
    ...
    {
        $commitMessage = "Update Windows.Devices.Spi version to $env:MyNuGetVersion"
